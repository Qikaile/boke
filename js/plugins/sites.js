const SitesJS = {
  ...
  start: (cfg) => {
    ...
    for (var i = 0; i < els.length; i++) {
      ...
      cfg.el = el;
      cfg.api = api;
      cfg.avatar = 'https://gcore.jsdelivr.net/gh/cdn-x/placeholder@1.0.1/link/8f277b4ee0ecd.svg';
      cfg.screenshot = 'https://gcore.jsdelivr.net/gh/cdn-x/placeholder@1.0.1/cover/76b86c0226ffd.svg';
      SitesJS.layout(cfg);
    }
  }
}
